...
function selectNucleotide(nucID,path) {
	...
	if (tab){
	  ...
	  if (d)
	  {
		...
		// R Plot
		var txt = "<img border='1' width='900' src='"+path+"/"+section+"/"+nuc.id+"/"+m+".dat.png'>";
						...
						var section = matches.toString().replace("Time_","");
				                ...
				                for(var j = 0; j < fc2.length; j++)
				                {
									...
									if (matches != undefined) {
										...
										//alert("Matches M: "+m);
	// R Plot
	var txt = "<img border='1' width='900' src='"+path+"/FORCE_CTES/"+nuc.id+"/"+m+".dat.png'>";
...
function selectNucleotideNew(analysis,nucID,path) {
	...
	// R Plot
	var txt = "<img border='1' width='900' src='"+path+"/"+section+"/"+path2+"/"+m+".dat.png'>";
...
function selectNucleotideStacking(nucID,path,length) {
    ...
    // R Plot
    var txt1 = "<img border='1' width='900' src='"+path+"/"+num1+"/"+code1+".dat.png'>";
    var txt2 = "<img border='1' width='900' src='"+path+"/"+num3+"/"+code2+".dat.png'>";
    var txt3 = "<img border='1' width='900' src='"+path+"/"+num1+"/"+code3+".dat.png'>";
    var txt4 = "<img border='1' width='900' src='"+path+"/"+num2+"/"+code4+".dat.png'>";

    // Download Buttons
    txt1 += '<table align="center" border="0"><tr><td>';
    ...
    txt1 += '</td><td>';
    txt1 += '<a href="getFile.php?fileloc='+path+'/'+num1+'/'+code1+'.dat&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>';
    txt1 += '</td></tr></table>';

    txt2 += '<table align="center" border="0"><tr><td>';
    ...
    txt2 += '</td><td>';
    txt2 += '<a href="getFile.php?fileloc='+path+'/'+num3+'/'+code2+'.dat&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>';
    txt2 += '</td></tr></table>';

    txt3 += '<table align="center" border="0"><tr><td>';
    ...
    txt3 += '</td><td>';
    txt3 += '<a href="getFile.php?fileloc='+path+'/'+num1+'/'+code3+'.dat&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>';
    txt3 += '</td></tr></table>';

    txt4 += '<table align="center" border="0"><tr><td>';
    ...
    txt4 += '</td><td>';
    txt4 += '<a href="getFile.php?fileloc='+path+'/'+num2+'/'+code4+'.dat&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>';
    txt4 += '</td></tr></table>';
...
function selectNucleotideStackingHB(nucID,path) {
    ...
    if (plot) {
	var txt = "<img border='1' width='900' src='"+path+"/"+num1+"/"+code1+".dat.png'>";
	...
	txt += '</td><td>';
	txt += '<a href="getFile.php?fileloc='+path+'/'+num1+'/'+code1+'.dat&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>';
	txt += '</td></tr></table>';
	...
	for(var i = 0; i < fc.length; i++) {
		...
		if(plot) {
			if(plot.tagName == 'DIV'){
				...
				var txt = "<img border='1' width='900' src='"+path+"/"+code+"."+helicalParm+".dat.png'>";
				...
				txt += '</td><td>';
				txt += '<a href="getFile.php?fileloc='+path+'/'+code+'.'+helicalParm+'.dat&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>';
				txt += '</td></tr></table>';
