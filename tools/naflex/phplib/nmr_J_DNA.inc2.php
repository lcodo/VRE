...
?>
	...
	<div id="Avg_Params">
		...
		<td id="Rib_Avg_images" rowspan="6">
                <img id="Rib_Avg" src="images/desoxyribose_trans.png" width="300" align="center" class="unhidden">
                <img id="J1p2ppSel_AvgRib" src="images/desoxyribose_J1p2pp_trans.png" width="300" align="center" class="hidden">
                <img id="J1p2pSel_AvgRib" src="images/desoxyribose_J1p2p_trans.png" width="300" align="center" class="hidden">
                <img id="J2pp3pSel_AvgRib" src="images/desoxyribose_J2pp3p_trans.png" width="300" align="center" class="hidden">
                <img id="J2p3pSel_AvgRib" src="images/desoxyribose_J2p3p_trans.png" width="300" align="center" class="hidden">
                <img id="J3p4pSel_AvgRib" src="images/desoxyribose_J3p4p_trans.png" width="300" align="center" class="hidden">
	...
	<div id="Time_Params">
		...
		<td id="Rib_images" rowspan="6">
                <img id="Rib" src="images/desoxyribose_trans.png" width="300" align="center" class="unhidden">
                <img id="J1p2pp-DNASelRib" src="images/desoxyribose_J1p2pp_trans.png" width="300" align="center" class="hidden">
                <img id="J1p2p-DNASelRib" src="images/desoxyribose_J1p2p_trans.png" width="300" align="center" class="hidden">
                <img id="J2pp3p-DNASelRib" src="images/desoxyribose_J2pp3p_trans.png" width="300" align="center" class="hidden">
                <img id="J2p3p-DNASelRib" src="images/desoxyribose_J2p3p_trans.png" width="300" align="center" class="hidden">
                <img id="J3p4p-DNASelRib" src="images/desoxyribose_J3p4p_trans.png" width="300" align="center" class="hidden">
		<p><i style="font-size:12pt">DNA 2-Deoxyribose</i></p>
		</td></tr>
		</table>
        </div>
...
<?php
	...
	?>
        ...
        <div id="J1p2pp-DNATimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="J1p2p-DNATimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="J2pp3p-DNATimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="J2p3p-DNATimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="J3p4p-DNATimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        </div>
