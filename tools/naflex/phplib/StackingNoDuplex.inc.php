	...
	<input type="hidden" name="path" value="<?php echo $path ?>" />
		...
		<td id="Rib_Avg_images" rowspan="6" align="center">
                <p id="Rib_Avg" class="unhidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
                <p id="stackingMeanSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
                <p id="stackingMinSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
                <p id="stackingMaxSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
                <p id="stackingStdevSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
                <p id="stackingZscoreSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
		<a href="http://iopenshell.usc.edu/research/projects/uracil-dimer/"><i style="font-size:8pt">[Image courtesy of iOpenShell]</i></a>
		<br/><br/>
		</td></tr>
		</table>
	...
	<div id="Time_Params">
		...
		<td id="Rib_images" rowspan="6" align="center">
                <p id="Rib" class="unhidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
                <p id="ATSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
                <p id="CGSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/stacking.png" target="_blank"><img src="images/stacking.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>HB/Stacking Energies</i></p>
		<a href="http://iopenshell.usc.edu/research/projects/uracil-dimer/"><i style="font-size:8pt">[Image courtesy of iOpenShell]</i></a>
		</td></tr>
		</table>
        </div>
	...
	<!-- PLOTS -->
        ...
        <div id="HelicalParamsPlots">
			...
			<?php plotAVG ($userPath,"energies/stackingContactMapsSTDEV"); ?>
                ...
                <div id="stackingAvgZscoreSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
