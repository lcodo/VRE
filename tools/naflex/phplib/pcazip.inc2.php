...
<script type="text/javascript">
  var script="load <?=$anim?>; cpk off; trace 0; select all; color red; anim mode palindrome; select backbone; trace 100; color blue; animation fps 5; anim on; background white;";
  var jmol = "jmol";
