...
?>
	...
	<input type="hidden" name="path" value="<?php echo $path ?>" />
		...
		<td id="Rib_Avg_images" rowspan="6" align="center">
                <p id="Rib_Avg" class="unhidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_trans.png" target="_blank"><img src="images/desoxyribose_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J1p2ppSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J1p2pp_trans.png" target="_blank"><img src="images/desoxyribose_J1p2pp_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J1p2pSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J1p2p_trans.png" target="_blank"><img src="images/desoxyribose_J1p2p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J2pp3pSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J2pp3p_trans.png" target="_blank"><img src="images/desoxyribose_J2pp3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J2p3pSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J2p3p_trans.png" target="_blank"><img src="images/desoxyribose_J2p3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J2p4pSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J2p4p_trans.png" target="_blank"><img src="images/desoxyribose_J2p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J2pp4pSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J2pp4p_trans.png" target="_blank"><img src="images/desoxyribose_J2pp4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J3p4pSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J3p4p_trans.png" target="_blank"><img src="images/desoxyribose_J3p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J1p3pSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J1p3p_trans.png" target="_blank"><img src="images/desoxyribose_J1p3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J1p4pSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J1p4p_trans.png" target="_blank"><img src="images/desoxyribose_J1p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="J56Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPyrimidine_56_trans.png" target="_blank"><img src="images/DPyrimidine_56_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine (segment)</i></p>
                <p id="J1p68Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_1p68_trans.png" target="_blank"><img src="images/D_1p68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J2p68Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_2p68_trans.png" target="_blank"><img src="images/D_2p68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J2pp68Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_2pp68_trans.png" target="_blank"><img src="images/D_2pp68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J3p68Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_3p68_trans.png" target="_blank"><img src="images/D_3p68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J4p68Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_4p68_trans.png" target="_blank"><img src="images/D_4p68_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J1p68-StepSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_1p68_Step_trans.png" target="_blank"><img src="images/D_1p68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J2p68-StepSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_2p68_Step_trans.png" target="_blank"><img src="images/D_2p68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J2pp68-StepSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_2pp68_Step_trans.png" target="_blank"><img src="images/D_2pp68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J3p68-StepSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_3p68_Step_trans.png" target="_blank"><img src="images/D_3p68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
                <p id="J4p68-StepSel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/D_4p68_Step_trans.png" target="_blank"><img src="images/D_4p68_Step_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Pyrimidine/Purine (segment)</i></p>
		...
		<p class="checkText" onClick="javascript:checkProton('Proton_Pairs_Avg','H2pp');">Check H2''</p>
                </td><td>
	...
	<div id="Time_Params">
		...
		<td id="Rib_images" rowspan="6" align="center">
                <p id="Rib" class="unhidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_trans.png" target="_blank"><img src="images/desoxyribose_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H1p-Nuc_H2pSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J1p2p_trans.png" target="_blank"><img src="images/desoxyribose_J1p2p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H1p-Nuc_H2ppSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J1p2pp_trans.png" target="_blank"><img src="images/desoxyribose_J1p2pp_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H1p-Nuc_H3pSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J1p3p_trans.png" target="_blank"><img src="images/desoxyribose_J1p3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H1p-Nuc_H4pSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J1p4p_trans.png" target="_blank"><img src="images/desoxyribose_J1p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="T_Nuc_H1p-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DT_1p6_trans.png" target="_blank"><img src="images/DT_1p6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Thymine</i></p>
                <p id="T_Nuc_H2p-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DT_2p6_trans.png" target="_blank"><img src="images/DT_2p6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Thymine</i></p>
                <p id="T_Nuc_H2pp-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DT_2pp6_trans.png" target="_blank"><img src="images/DT_2pp6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Thymine</i></p>
                <p id="T_Nuc_H3p-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DT_3p6_trans.png" target="_blank"><img src="images/DT_3p6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Thymine</i></p>
                <p id="T_Nuc_H4p-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DT_4p6_trans.png" target="_blank"><img src="images/DT_4p6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Thymine</i></p>
                <p id="C_Nuc_H1p-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DC_1p6_trans.png" target="_blank"><img src="images/DC_1p6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Cytosine</i></p>
                <p id="C_Nuc_H2p-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DC_2p6_trans.png" target="_blank"><img src="images/DC_2p6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Cytosine</i></p>
                <p id="C_Nuc_H2pp-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DC_2pp6_trans.png" target="_blank"><img src="images/DC_2pp6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Cytosine</i></p>
                <p id="C_Nuc_H3p-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DC_3p6_trans.png" target="_blank"><img src="images/DC_3p6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Cytosine</i></p>
                <p id="C_Nuc_H4p-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DC_4p6_trans.png" target="_blank"><img src="images/DC_4p6_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Cytosine</i></p>
                <p id="C_Nuc_H5-Nuc_H6SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DC_56_trans.png" target="_blank"><img src="images/DC_56_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Cytosine</i></p>
                <p id="G_Nuc_H1p-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DG_1p8_trans.png" target="_blank"><img src="images/DG_1p8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Guanine</i></p>
                <p id="G_Nuc_H2p-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DG_2p8_trans.png" target="_blank"><img src="images/DG_2p8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Guanine</i></p>
                <p id="G_Nuc_H2pp-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DG_2pp8_trans.png" target="_blank"><img src="images/DG_2pp8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Guanine</i></p>
                <p id="G_Nuc_H3p-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DG_3p8_trans.png" target="_blank"><img src="images/DG_3p8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Guanine</i></p>
                <p id="G_Nuc_H4p-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DG_4p8_trans.png" target="_blank"><img src="images/DG_4p8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Guanine</i></p>
                <p id="A_Nuc_H1p-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DA_1p8_trans.png" target="_blank"><img src="images/DA_1p8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Adenine</i></p>
                <p id="A_Nuc_H2p-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DA_2p8_trans.png" target="_blank"><img src="images/DA_2p8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Adenine</i></p>
                <p id="A_Nuc_H2pp-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DA_2pp8_trans.png" target="_blank"><img src="images/DA_2pp8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Adenine</i></p>
                <p id="A_Nuc_H3p-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DA_3p8_trans.png" target="_blank"><img src="images/DA_3p8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Adenine</i></p>
                <p id="A_Nuc_H4p-Nuc_H8SelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DA_4p8_trans.png" target="_blank"><img src="images/DA_4p8_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>DNA Adenine</i></p>
                <p id="Nuc_H2p-Nuc_H3pSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J2p3p_trans.png" target="_blank"><img src="images/desoxyribose_J2p3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H2pp-Nuc_H3pSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J2pp3p_trans.png" target="_blank"><img src="images/desoxyribose_J2pp3p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H2p-Nuc_H4pSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J2p4p_trans.png" target="_blank"><img src="images/desoxyribose_J2p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H2pp-Nuc_H4pSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J2pp4p_trans.png" target="_blank"><img src="images/desoxyribose_J2pp4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H3p-Nuc_H4pSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/desoxyribose_J3p4p_trans.png" target="_blank"><img src="images/desoxyribose_J3p4p_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>DNA 2-Deoxyribose</i></p>
                <p id="Nuc_H1p-Nuc_H6-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPurines_Pyrimidines_1p6_trans.png" target="_blank"><img src="images/DPurines_Pyrimidines_1p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Pyrimidine (Segment)</i></p>
                <p id="Nuc_H2p-Nuc_H6-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPurines_Pyrimidines_2p6_trans.png" target="_blank"><img src="images/DPurines_Pyrimidines_2p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Pyrimidine (Segment)</i></p>
                <p id="Nuc_H2pp-Nuc_H6-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPurines_Pyrimidines_2pp6_trans.png" target="_blank"><img src="images/DPurines_Pyrimidines_2pp6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Pyrimidine (Segment)</i></p>
                <p id="Nuc_H3p-Nuc_H6-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPurines_Pyrimidines_3p6_trans.png" target="_blank"><img src="images/DPurines_Pyrimidines_3p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Pyrimidine (Segment)</i></p>
                <p id="Nuc_H4p-Nuc_H6-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPurines_Pyrimidines_4p6_trans.png" target="_blank"><img src="images/DPurines_Pyrimidines_4p6_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Pyrimidine (Segment)</i></p>
                <p id="Nuc_H1p-Nuc_H8-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPyrimidines_Purines_1p8_trans.png" target="_blank"><img src="images/DPyrimidines_Purines_1p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Purine (Segment)</i></p>
                <p id="Nuc_H2p-Nuc_H8-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPyrimidines_Purines_2p8_trans.png" target="_blank"><img src="images/DPyrimidines_Purines_2p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Purine (Segment)</i></p>
                <p id="Nuc_H2pp-Nuc_H8-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPyrimidines_Purines_2pp8_trans.png" target="_blank"><img src="images/DPyrimidines_Purines_2pp8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Purine (Segment)</i></p>
                <p id="Nuc_H3p-Nuc_H8-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPyrimidines_Purines_3p8_trans.png" target="_blank"><img src="images/DPyrimidines_Purines_3p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Purine (Segment)</i></p>
                <p id="Nuc_H4p-Nuc_H8-StepSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/DPyrimidines_Purines_4p8_trans.png" target="_blank"><img src="images/DPyrimidines_Purines_4p8_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>* - Purine (Segment)</i></p>
		</td></tr>
		</table>
        </div>
        </div>
	...
	<!-- PLOTS -->
        ...
        <div id="HelicalParamsPlots">
			...
			<?php plotAVG ($userPath,"H1p-H2p.avg"); ?>
                ...
                <div id="J1p2pp-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
			...
			<?php plotAVG ($userPath,"H2p-H4p.avg"); ?>
                ...
                <div id="J2pp4p-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
			<?php plotAVG ($userPath,"H2pp-H4p.avg"); ?>
                </div>
                <div id="J2pp3p-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
			...
			<?php plotAVG ($userPath,"H2p-H6H8.avg"); ?>
                ...
                <div id="J2pp68-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
			...
			<?php plotAVG ($userPath,"H2p-H6H8-Step.avg"); ?>
                ...
                <div id="J2pp68-Step-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
...
<?php
	...
	?>
        ...
        <div id="Nuc_H1p-Nuc_H2ppTimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        ...
        <div id="Nuc_H2pp-Nuc_H3pTimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="Nuc_H2pp-Nuc_H4pTimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="Nuc_H2pp-Nuc_H6TimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        ...
        <div id="Nuc_H2pp-Nuc_H6-StepTimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        ...
        <div id="Nuc_H2pp-Nuc_H8-StepTimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
