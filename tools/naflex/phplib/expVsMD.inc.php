...
<br/>
	<div id="AvgVsTime">
         ...
         <table cellpadding="15" align="center" border="0" class="avgParms">
			...
			<!--<td width="50"></td>-->
                        <td class="curvesText" style="display: none";><a id='TIMESel' class='unselected' href="javascript:unhideSections('TIMESel','TimeParams');" title='TIME Results'>Results by Time</a></td>
		</tr>
	</table>
	</div>
	...
	<div id="HelicalParams" class="hidden">
	 <table cellpadding="15" align="center" border="0" class="avgParms">
			...
			<td></td>
			<td class="curvesText"><a id='AxisSel' class='unselected' href="javascript:unhideSections('AxisSel','Axis');" title='Axis'>Axis Base Pair</a></td>
			<td></td>
			<td class="curvesText"><a id='BP_HelicalParmsSel' class='unselected' href="javascript:unhideSections('BP_HelicalParmsSel','BP_HelicalParms');" title='Base Pair Helical Parameters'>Intra-Base Pair Helical Parameters </a></td>
			<td></td>
			<td class="curvesText"><a id='BPS_HelicalParmsSel' class='unselected' href="javascript:unhideSections('BPS_HelicalParmsSel','BPS_HelicalParms');" title='Base Pair Step Helical Parameters'>Inter-Base Pair Helical Parameters </a></td>
<!--			<td></td>
...
-->		</tr>
        ...
        <div id="TimeParams" class="hidden">
         <table cellpadding="15" align="center" border="0" class="avgParms">
			...
			<td></td>
			<td class="curvesText"><a id='AxisTimeSel' class='unselected' href="javascript:unhideSections('AxisTimeSel','AxisTime');" title='Axis'>Axis Base Pair</a></td>
			<td></td>
                        <td class="curvesText"><a id='BP_HelicalParmsTimeSel' class='unselected' href="javascript:unhideSections('BP_HelicalParmsTimeSel','BP_HelicalParmsTime');" title='Base Pair Helical Parameters'>Intra-Base Pair Helical Parameters </a></td>
			<td></td>
                        <td class="curvesText"><a id='BPS_HelicalParmsTimeSel' class='unselected' href="javascript:unhideSections('BPS_HelicalParmsTimeSel','BPS_HelicalParmsTime');" title='Base Pair Step Helical Parameters'>Inter-Base Pair Helical Parameters </a></td>
			<td></td>
	...
	<div id="HelicalParamsSectionsTime" style="text-align:center;">
		...
		<td rowspan="4">
                <img src="images/axis-bp.png" align="center" border="0" usemap="#axisBP_TimeMap">
		...
		<td rowspan="6">
                <img src="images/helicalParamsBP.png" align="center" border="0" usemap="#helicalParamsBP_TimeMap" >
		<a href="http://gbio-pbil.ibcp.fr/Curves_plus/Helical_parameters.html"><i style="font-size:8pt"><br/><br/>[Image courtesy of Curves+]</i></a> 
		</td></tr>
		</table>
        </div>
		...
		<td rowspan="6">
                <img src="images/helicalParamsBPS_exp.png" align="center" border="0" usemap="#helicalParamsBPS_TimeMap" style="padding-bottom: 15px;">
		<a href="http://gbio-pbil.ibcp.fr/Curves_plus/Helical_parameters.html"><i style="font-size:8pt"><br/><br/>[Image courtesy of Curves+]</i></a> 
		</td></tr>
		</table>
        </div>
	...
	<div id="Axis" class="hidden">
		...
		<td rowspan="4">
                <img src="images/axis-bp_exp.png" align="center" border="0" usemap="#axisBP_Map">
		<a href="http://gbio-pbil.ibcp.fr/Curves_plus/Helical_parameters.html"><i style="font-size:8pt"><br/><br/>[Image courtesy of Curves+]</i></a> 
		</td></tr>
		</table>
	</div>
	...
	<div id="BP_HelicalParms" class="hidden">
		...
		<td rowspan="6">
                <img src="images/helicalParamsBP_exp.png" align="center" border="0" usemap="#helicalParamsBP_Map" style="padding-bottom: 15px;">
	...
	<div id="BPS_HelicalParms" class="hidden">
		...
		<td rowspan="6">
                <img src="images/helicalParamsBPS_exp.png" align="center" border="0" usemap="#helicalParamsBPS_Map">
		<a href="http://gbio-pbil.ibcp.fr/Curves_plus/Helical_parameters.html"><i style="font-size:8pt"><br/>[Image courtesy of Curves+]</i></a> 
		</td></tr>
		</table>
	</div>
