...
?>
	...
	<div id="AvgVsTime">
         ...
         <table cellpadding="15" align="center" border="0" class="avgParms">
                <tr>
                        <td class="curvesText"><a id='AVGSel' class='unselected' href="javascript:unhideStiffnessAvgPlots('AVGSel','HelicalParams');" title='AVG Results'>Average Results</a></td>
			<td width="50"></td>
                        <td class="curvesText"><a id='TIMESel' class='unselected' href="javascript:unhideStiffnessTimePlots('TIMESel','BPS_HelicalParmsTime');" title='TIME Results'>Results by Time</a></td>
		</tr>
	</table>
	</div>
	...
	<div id="HelicalParamsPlots">
	        ...
	        <div id="riseSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
                	<?php plotAVG ($userPath,"FORCE_CTES/rise_avg"); ?>
		</div>
	        <div id="rollSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
                	<?php plotAVG ($userPath,"FORCE_CTES/roll_avg"); ?>
		</div>
	        <div id="shiftSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
                	<?php plotAVG ($userPath,"FORCE_CTES/shift_avg"); ?>
		</div>
        	<div id="slideSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
                	<?php plotAVG ($userPath,"FORCE_CTES/slide_avg"); ?>
		</div>
	        <div id="tiltSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
                	<?php plotAVG ($userPath,"FORCE_CTES/tilt_avg"); ?>
		</div>
	        <div id="twistSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
	...
	<?php
		...
		?>
                        <p align='left'><b>Units:<br/> </b><i>Diagonal Shift/Slide/Rise in kcal/(mol*&Aring;&sup2;), Diagonal Tilt/Roll/Twist in kcal/(mol*degree&sup2;)<br/>
                        Out of Diagonal: Shift/Slide/Rise in kcal/(mol*&Aring;), Out of Diagonal Tilt/Roll/Twist in kcal/(mol*degree)</i></p>

			<table align="center" border="0"><tr><td>
			</td><td>
			<a href="getFile.php?fileloc=<?php echo $userPath."/".$file ?>&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>
			</td><td>
...
function printCurvesImage() {
	...
	$code = '<table align="center" border="0"><tr><td>';
	$code .= '<img border="0" align="right" src="images/helicalParamsBPS2.png">';
	$code .= '</td></tr><tr><td align="center">';
	$code .= '<a href="http://gbio-pbil.ibcp.fr/Curves_plus/Helical_parameters.html"><i style="font-size:8pt"><br/><br/>[Image courtesy of Curves+]</i></a>';
	$code .= '</td></tr></table>';
