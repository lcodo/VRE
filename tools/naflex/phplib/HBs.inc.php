...
?>
	...
	<input type="hidden" name="path" value="<?php echo $path ?>" />
		...
		<td id="Rib_Avg_images" rowspan="6" align="center">
                <p id="Rib_Avg" class="unhidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/CG_AT_HB_trans.png" target="_blank"><img src="images/CG_AT_HB_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>Base Pair Canonical Hydrogen Bonds</i></p>
                <p id="N1H3Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/AT_HB_trans.png" target="_blank"><img src="images/AT_HB_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>Adenine-Thymine/Uracil Canonical HBs</i></p>
                <p id="H61O4Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/AT_HB_trans.png" target="_blank"><img src="images/AT_HB_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>Adenine-Thymine/Uracil Canonical HBs</i></p>
                <p id="O6H41Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/CG_HB_trans.png" target="_blank"><img src="images/CG_HB_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>Guanine-Cytosine Canonical HBs</i></p>
                <p id="H1N3Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/CG_HB_trans.png" target="_blank"><img src="images/CG_HB_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>Guanine-Cytosine Canonical HBs</i></p>
                <p id="H21O2Sel_AvgRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/CG_HB_trans.png" target="_blank"><img src="images/CG_HB_trans.png" border="0" width="400" align="center"></a><i style="font-size:12pt"><br/><br/>Guanine-Cytosine Canonical HBs</i></p>
		<br/><br/>
	...
	<div id="Time_Params">
		...
		<td id="Rib_images" rowspan="6" align="center">
                <p id="Rib" class="unhidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/CG_AT_HB_trans.png" target="_blank"><img src="images/CG_AT_HB_trans.png" border="0" width="300" align="center"></a><i style="font-size:12pt"><br/><br/>Base Pair Canonical Hydrogen Bonds</i></p>
                <p id="ATSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/AT_HB_trans.png" target="_blank"><img src="images/AT_HB_trans.png" border="0" width="500" align="center"></a><i style="font-size:12pt"><br/><br/>Adenine-Thymine/Uracil Canonical HBs</i></p>
                <p id="CGSelRib" class="hidden"><a href="<?php echo $GLOBALS[homeURL] ?>/images/CG_HB_trans.png" target="_blank"><img src="images/CG_HB_trans.png" border="0" width="500" align="center"></a><i style="font-size:12pt"><br/><br/>Guanine-Cytosine Canonical HBs</i></p>
		</td></tr>
		</table>
        </div>
        </div>
	...
	<!-- PLOTS -->
        ...
        <div id="HelicalParamsPlots">
                ...
                <div id="N1H3-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
			<?php plotAVG ($userPath,"N1-H3.avg"); ?>
                </div>
                <div id="H61O4-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
			<?php plotAVG ($userPath,"H61-O4.avg"); ?>
                </div>
                <div id="O6H41-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
			<?php plotAVG ($userPath,"O6-H41.avg"); ?>
                </div>
                <div id="H1N3-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
			<?php plotAVG ($userPath,"H1-N3.avg"); ?>
                </div>
                <div id="H21O2-DNAAvgSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;">
...
<?php
	...
	?>
		...
		<a href="getFile.php?fileloc=<?php echo $userPath."/ALL.stats" ?>&type=curves"> <p align="right" class="curvesDatText">Download Raw Data</p></a>
		</td></tr></table>
	</div>
	</div>
	</div>
        ...
        <div id="Nuc_N1-Nuc_H3TimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="Nuc_H61-Nuc_O4TimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="Nuc_O6-Nuc_H41TimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="Nuc_H1-Nuc_N3TimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        <div id="Nuc_H21-Nuc_O2TimeSelPlot" class="hidden" style="text-align:center; background-color: #:#E6E6FA;padding: 15px 20px;"></div>
        </div>
