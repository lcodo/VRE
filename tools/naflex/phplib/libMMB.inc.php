...
<div id="divbase">
  <div id="toplogo">
  <a id="top_box_mdweb_link" href="<?php echo $GLOBALS['mmbURL']?>/MDWeb"><b>Powered by</b></p><img src="<?php echo $GLOBALS['homeURL']?>/images/LogoMDWEB.png" height="30" border="0" alt="Molecular Dynamics on Web"></a>
...
function footerNA () {
  ...
  <div id="bottomlogo">
    <div id="textBottom">  
     <a id="mmbLogo" href="http://mmb.irbbarcelona.org"><img src="<?php echo $GLOBALS['homeURL']?>/images/mmb_logo_trans.png" height="50" border="0" alt="MMB group"></a>
     <a id="contactUs" href="mailto:naflex@mmb.pcb.ub.es" target="_blank">Contact us. &copy; 2012</a>
     <a id="bottom_box_scalalife_link" href="http://www.scalalife.eu"><img src="<?php echo $GLOBALS['homeURL']?>/images/scalalife.png" height="50" border="0" alt="Scalalife Project"></a> 
     <a id="bottom_box_ub_link" href="http://www.ub.edu"><img src="<?php echo $GLOBALS['homeURL']?>/images/logoUB.png" height="70" border="0" alt="Universitat de Barcelona"></a> 
     <a id="bottom_box_bsc_link" href="http://www.bsc.es"><img src="<?php echo $GLOBALS['homeURL']?>/images/BSC-Logo.png" height="80" border="0" alt="Barcelona Supercomputing Center"></a> 
     <a id="bottom_box_isc3_link" href="http://www.isciii.es"><img src="<?php echo $GLOBALS['homeURL']?>/images/isciii.png" height="80" border="0" alt="Instituto de Salud Carlos III"></a> 
     <a id="bottom_box_irb_link" href="http://www.irbbarcelona.org"><img src="<?php echo $GLOBALS['homeURL']?>/images/IRB_barcelona.png" height="80" border="0" alt="Institute for Research in Biomedicine"></a> 
     </div>
  </div>
</div>
<script>
