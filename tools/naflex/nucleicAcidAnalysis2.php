...
if(preg_match('/^PDB_NMR/',$analysis)){
	$path = "$dir/$proj/PDB/$analysis/CURVES";
	$userPath = $GLOBALS['parmbsc1Dir']."/$proj/PDB/$analysis/CURVES";
}
...
<?php
	...
	case (preg_match('/^PDB_NMR/', $analysisType) ? true : false) :
	case 'PDB':
